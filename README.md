...
La libreria puede realizar seis operaciones de números complejos. Cada número de entrada se debe escribir como un tupla ``(a,b)`` que representara el número complejo $a + bi$. Las operaciones que puede realizar esta calculadora son:
...
## 5. Módulo
Dado un numero complejo $C_1 = (a_1, b_1)$, la calculadora sigue la siguiente fórmula para realizar $|C_1|$:
...
## 6. Conjugado
Dado un numero complejo $C_1 = (a_1, b_1)$, la calculadora sigue la siguiente fórmula para realizar $\overline{C_1}$:
